...
f.addEventListener('submit', (e) => {
    ...
    document.title=ab+''+name+' Giant 5 Layer Quote';
    const date = new Date();
...
<table>
  ...
  <tr>
    ...
    <td><b><span class="total"><h2>&#x20B9;${feet * rate5 * 100 / 100}</span></h2><b>
(18 % GST Including)</td>
  </tr>
...
<ol style="margin-left: 50px; line-height:1.8rem; font-weight:600; font-style:italic;">
    ...
    <li>Apply 1st Coat Giant RainPrime with cement.</li>
    <li>Apply 2nd coating of Giant Fibermesh.</li>
    <li>Apply 3rd & 4th coating of Giant RainPrime with cement dilution.</li>
    <li>Apply 5th coating of SafeCoat with cement without dilution.</li>
</ol>
</p>
...
<div class="t-and-d">
            ...
            <h4 style="border:1px solid blue; padding: 20px; margin-top:20px;">Warranty : 5 Years (five Years) (for 5 Layer Waterproofing Service ) <b>T&C Apply</b>
                </h4> 
    ...
    <div class="contact">
        ...
        <p class="contact-details">
            ...
            Email: <b><span class="email">info@giant.com.co</span></b>
